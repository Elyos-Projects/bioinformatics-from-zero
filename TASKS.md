...
Elyos taskSchema; the Elyos CLI executes these JSON files, not this Markdown). The seed
...
"How these tasks map to Elyos": `lane: donated`, `verifiedNeed: false`, `urgent: false`,
